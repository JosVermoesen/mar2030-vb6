...
marIntegraal is a complete bookkeeping program around the Minimum Classification General Accounting System (Belgium). This is the Visual Basic 6 version of the program.

![MARINTEGRAAL](img/marIntegraalVB6.png)
...
- From 2026, we will serve our customers 100% by delivering programs 'as a service'. More information will follow.
- At the moment (2026), in this Open Source version, we are having fun translating and testing the reporting functions from the commercial version. You can freely view our work in progress if you wish
- Have fun!
