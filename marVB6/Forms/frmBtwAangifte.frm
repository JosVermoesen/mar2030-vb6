...
VulDeVelden BYPERDAT.Boekjaar.text, Format(BYPERDAT.PeriodeBoekjaar.ListIndex + 1, "00")
'BYPERDAT.Boekjaar.Text + Format(BYPERDAT.PeriodeBoekjaar.ListIndex + 1, "00")
End Sub
...
TekstInfo(28).text = Format(BYPERDAT.PeriodeBoekjaar.ListIndex + 1, "00")
TekstInfo(29).text = Right(BYPERDAT.PeriodeBoekjaar.text, 10)
