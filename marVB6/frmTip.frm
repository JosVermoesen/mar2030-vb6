...
Begin VB.Form frmTip 
   ...
   Begin VB.CommandButton cmdWijzigMetNotepad 
      Caption         =   "Wijzigen met &Notepad"
      Height          =   495
      Left            =   4080
      TabIndex        =   6
      TabStop         =   0   'False
   ...
   Begin VB.CheckBox chkLoadTipsAtStartup 
      Caption         =   "&Tips tonen bij opstart"
      Height          =   315
      Left            =   120
      TabIndex        =   3
      Top             =   2940
...
Private Sub cmdWijzigMetNotepad_Click()

If Dir(App.path + "\" + TIP_FILE) = "" Then
    MsgBox "Enkel deze knop te gebruiken om te wijzigen..."
Else
    If Shell("notepad " & App.path & "\" & TIP_FILE, 1) Then
    End If
...
Private Sub Form_Load()
    ...
    If LoadTips(App.path & "\" & TIP_FILE) = False Then
        lblTipText.Caption = "Het " & TIP_FILE & " bestand niet bestaat? " & vbCrLf & vbCrLf & _
           "Maak een tekstbestand genaamd " & TIP_FILE & " met NotePad, één tip per lijn. " & _
           "Plaats dit bestand vervolgens in dezelfde inhoudsopgave als de toepassing. "
    End If
